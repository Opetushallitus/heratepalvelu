(defproject heratepalvelu "0.1.0-SNAPSHOT"
  ...
  :managed-dependencies [[org.clojure/clojure "1.12.0"]
                         ...
                         [software.amazon.awssdk/aws-core "2.29.21"]
                         [software.amazon.awssdk/dynamodb "2.29.21"]
                         [software.amazon.awssdk/ssm "2.29.21"]
                         [software.amazon.awssdk/sqs "2.29.21"]
                         [software.amazon.awssdk/bom "2.29.21" :extensions "pom"]
