...
(defn- amispalaute-body-alkukysely
  ...
  (let [link-with-tracking (str link "?t=e")]
    [:div
     [:p "Hyvä opiskelija!"]
     [:p (str "Henkilökohtainen osaamisen kehittämissuunnitelmasi (HOKS) on "
     ...
     [:p (str "Toivomme, että käyttäisit noin 10-15 minuuttia aikaa tähän "
              ...
              "opiskeluilmapiiriä.")]
     [:p (str "Palaute annetaan nimettömänä. Vastauksiasi käytetään "
     ...
     [:p (str "Your feedback will be collected anonymously. Your responses "
...
(defn- amispalaute-body-loppukysely
  ...
  (let [link-with-tracking (str link "?t=e")]
    [:div
     [:p "Hyvä opiskelija!"]
     [:p (str "Olet edennyt hienosti ja saamassa päätökseen tavoitteesi "
     ...
     horizontal-line
     [:p "Dear student!"]
     [:p (str "You have progressed well and are about to complete the "
  ...
  (let [link-with-tracking (str link "?t=e")]
    [:div
     [:p (str "Olethan muistanut antaa palautetta oppilaitokselle!<br/>"
              "Kom ihåg att ge respons till läroanstalten!<br/>Please remember "
              "to give feedback to the educational institution!")]
     [:p [:a {:href link-with-tracking} link-with-tracking]]
     [:p (str "Jos linkki ei avaudu, kopioi linkki selaimesi osoiteriville."
              "<br/>Om du kan inte öppna länken, kopiera (och klistra in) "
...
(defn- tyopaikkaohjaaja-body
  ...
  [data oppilaitokset]
  (let [link-with-tracking (str (:kyselylinkki data) "?t=e")]
    [:div
     ...
     [:p (str "Vi ber er svara på den här enkäten (5 min) för att utveckla "
  ...
  (let [link-with-tracking (str (:kyselylinkki data) "?t=e")]
    [:div
     ...
     [:p (str "Please answer this survey (5 min) to help us work together more "
              "effectively. We would like to hear about your experiences "
              "guiding students and working with the educational institution. "
              "The survey does not assess the student. The survey can be "
              "forwarded to another person at your workplace if he or she has "
              "guided the student more. Respondent´s personal information is "
